...
describe("base: Aerodrome gauge Testing", function () {
  before("Initial set up", async function () {
    ...
    plugin0 = await ethers.getContractAt(
      "contracts/plugins/base/AeroGaugePluginFactory.sol:AeroGaugePlugin",
  ...
  it("LPGauge data ", async function () {
    ...
    console.log(
      "Claimable AERO: ",
      await LP0Gauge.connect(owner).earned(plugin0.address)
    );
    console.log();
    ...
    console.log(
      "Claimable AERO: ",
      await LP1Gauge.connect(owner).earned(plugin1.address)
    );
    console.log();
  });
